<div class="d-flex flex-column align-items-center">
    ...
    <div class="ww_license d-flex mb-4">
    ...
    <div class="ww_plugin--rate d-flex flex-column align-items-center">
        <input type="text" name="license" class="mb-4" id="ww_license--input" placeholder="Enter license key">
		<input type="submit"  style=" width: 15rem;" class="mb-2 ww_btn btn btn-primary" value="Activate"	>
		<input type="submit" style=" width: 15rem; background-color: #707070; border:solid #707070" class="mb-2 ww_btn btn btn-primary" value="Buy now">

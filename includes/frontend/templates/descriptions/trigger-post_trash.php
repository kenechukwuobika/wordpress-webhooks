...
<?php echo wordpress_webhooks()->helpers->translate( "This webhook trigger is used to send data, on trashing a post, to one or multiple given webhook URL's.", $translation_ident ); ?>
<br>
<?php echo wordpress_webhooks()->helpers->translate( "This description is uniquely made for the <strong>Send Data On Post Trash</strong> (post_trash) webhook trigger.", $translation_ident ); ?>
<br><br>
<h4><?php echo wordpress_webhooks()->helpers->translate( "How to use <strong>Send Data On Post Trash</strong> (post_trash)", $translation_ident ); ?></h4>
<ol>
...
<br>
<?php echo wordpress_webhooks()->helpers->translate( "This trigger is registered on the <strong>trashed_post</strong> hook:", $translation_ident ); ?> 
...
<ol>
    <li><?php echo wordpress_webhooks()->helpers->translate( "<strong>Important</strong>: Please note that in case this trigger does not fire, either your post type does not support the trash status, or automatic cleaning time is reached.", $translation_ident ); ?></li>

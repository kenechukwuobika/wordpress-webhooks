...
<?php echo wordpress_webhooks()->helpers->translate( "This webhook trigger is used to send data, after deletion of a user, to one or multiple given webhook URL's.", $translation_ident ); ?>
<br>
<?php echo wordpress_webhooks()->helpers->translate( "This description is uniquely made for the <strong>Send Data On User Deletion</strong> (deleted_user) webhook trigger.", $translation_ident ); ?>
<br><br>
<h4><?php echo wordpress_webhooks()->helpers->translate( "How to use <strong>Send Data On User Deletion</strong> (deleted_user)", $translation_ident ); ?></h4>
<ol>
...
<br>
<?php echo wordpress_webhooks()->helpers->translate( "This trigger is registered on the <strong>deleted_user</strong> hook:", $translation_ident ); ?> 
...
<br>
<br>
<?php echo wordpress_webhooks()->helpers->translate( "<strong>Important</strong>: If case have a multisite network set up, this webhook only fires if you delete the user from the whole network and not only from one sub site.", $translation_ident ); ?>
<br>
<br>

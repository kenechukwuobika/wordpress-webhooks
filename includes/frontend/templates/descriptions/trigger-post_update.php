...
<?php echo wordpress_webhooks()->helpers->translate( "This webhook trigger is used to send data, on the update of a post, to one or multiple given webhook URL's.", $translation_ident ); ?>
<br>
<?php echo wordpress_webhooks()->helpers->translate( "This description is uniquely made for the <strong>Send Data On Post Update</strong> (post_update) webhook trigger.", $translation_ident ); ?>
<br><br>
<h4><?php echo wordpress_webhooks()->helpers->translate( "How to use <strong>Send Data On Post Update</strong> (post_update)", $translation_ident ); ?></h4>
<ol>
...
<br>
<?php echo wordpress_webhooks()->helpers->translate( "This trigger is registered on the <strong>attachment_updated</strong> hook and the <strong>wp_insert_post</strong> hook:", $translation_ident ); ?> 
<br>
<strong><?php echo wordpress_webhooks()->helpers->translate( "Attachment updated", $translation_ident ); ?></strong>: <a title="wordpress.org" target="_blank" href="https://developer.wordpress.org/reference/hooks/attachment_updated/">https://developer.wordpress.org/reference/hooks/attachment_updated/</a>
<br>
<strong><?php echo wordpress_webhooks()->helpers->translate( "Update post", $translation_ident ); ?></strong>: <a title="wordpress.org" target="_blank" href="https://developer.wordpress.org/reference/hooks/wp_insert_post/">https://developer.wordpress.org/reference/hooks/wp_insert_post/</a>
<br><br>
...
<br>
<?php echo wordpress_webhooks()->helpers->translate( "The <strong>wp_insert_post</strong> hook is fired as well for the post update - we diversify between them through the third parsed parameter called <code>\$update</code>, which returns true or false.", $translation_ident ); ?>
<br>
<br>

...
<?php echo wordpress_webhooks()->helpers->translate( "This webhook trigger is used to send data, on the update of a user, to one or multiple given webhook URL's.", $translation_ident ); ?>
<br>
<?php echo wordpress_webhooks()->helpers->translate( "This description is uniquely made for the <strong>Send Data On User Update</strong> (update_user) webhook trigger.", $translation_ident ); ?>
<br><br>
<h4><?php echo wordpress_webhooks()->helpers->translate( "How to use <strong>Send Data On User Update</strong> (update_user)", $translation_ident ); ?></h4>
<ol>
...
<br>
<?php echo wordpress_webhooks()->helpers->translate( "This trigger is registered on the <strong>profile_update</strong> hook:", $translation_ident ); ?> 

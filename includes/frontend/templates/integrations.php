<h2>    Extensions for <?php echo wordpress_webhooks()->settings->get_page_title(); ?> </h2>

<div>
This page contains all approved extensions for <strong><?php echo wordpress_webhooks()->settings->get_page_title(); ?></strong>. You will be able to fully manage each of the extensions right within this plugin. In case you want to list your very own plugin here, feel free to <a title="Go to our contact form" target="_blank" href="#">reach out to us</a>.    </div>

...
/**
 * WordPress_Webhooks_Post_Delay Class
 *
...
class WordPress_Webhooks_Post_Delay {
    ...
    /**
	 * WordPress_Webhooks_Post_Delay constructor.
	 */
    function __construct(){
        $this->is_active = ( get_option( 'ww_deactivate_post_delay' ) == 'yes' ) ? false : true;
        $this->add_hooks();
    }
    ...
    public function launch_delayed_triggers(){
        $triggers = apply_filters( 'ww/post_delay/post_delay_triggers', $this->post_delay_triggers );
